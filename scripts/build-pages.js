...
const site = {
  ...
  "lead": "Track exported features and consumer usage so breaking API changes are caught before release.",
  "quickstart": "pnpm add -D @async/api-contract\npnpm run pipeline:verify",
  "docsRoots": [
    "docs"
  ]
};
